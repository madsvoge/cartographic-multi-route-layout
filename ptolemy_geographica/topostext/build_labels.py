...
_PROVINCE_LABELS = [
    ...
    ("6.01", "Assyria", ""),
    ("6.02", "Media", ""),
    ("6.03", "Susiane", "Susiana, roughly modern Khuzestan"),
    ("6.04", "Persis", ""),
    ("6.05", "Parthia", ""),
    ("6.06", "Karmania Deserta", "Desert Karmania"),
    ("6.07", "Eudaimon Arabia", "Arabia Felix"),
    ("6.08", "Karmania", ""),
    ("6.09", "Hyrkania", "Hyrcania"),
    ("6.10", "Margiane", ""),
    ("6.11", "Bactriane", "Bactria"),
    ("6.12", "Sogdianoi", "Sogdiana"),
    ("6.13", "Sakai", "the Saka lands"),
    ("6.14", "Scythia within Imaos", ""),
    ("6.15", "Scythia beyond Imaos", ""),
    ("6.16", "Serike", "roughly China"),
    ("6.17", "Areia", "the Herat region"),
    ("6.18", "Paropanisadai", "the Hindu Kush/Kabul region"),
    ("6.19", "Drangiane", ""),
    ("6.20", "Arachosia", "the Kandahar region"),
    ("6.21", "Gedrosia", ""),
    ("7.01", "India within the Ganges", "India intra Gangem"),
    ("7.02", "India beyond the Ganges", "India extra Gangem, roughly Southeast Asia"),
    ("7.03", "Sinai", "roughly the region beyond mainland Southeast Asia"),
    ("7.04", "Taprobane", "Sri Lanka"),
]
